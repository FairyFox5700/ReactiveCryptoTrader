...
namespace CryptoTracker.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "CryptoTracker.WebApi", Version = "v1"});
            });
            services.Configure<TradingConfiguration>(
                Configuration.GetSection(nameof(TradingConfiguration)));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "CryptoTracker.WebApi v1"));
            }
